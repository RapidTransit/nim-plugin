...
import org.nim.sdk.roots.NimSdkRootsAsVirtualFilePointers;

public class NimProjectSdkImpl extends UserDataHolderBase implements NimSdk, NimSdkModificator, Disposable {
  ...
  private final NimSdkRootsAsVirtualFilePointers myRoots;
  private NimProjectSdkImpl myOrigin;
  private NimSdkAdditionalData myAdditionalData;
  private NimSdkTypeId mySdkType;
  ...
  public NimProjectSdkImpl(String name, NimSdkTypeId sdkType) {
    mySdkType = sdkType;
    myName = name;

    myRoots = new NimSdkRootsAsVirtualFilePointers(true, tellAllProjectsTheirRootsAreGoingToChange, this);
  ...
  public NimProjectSdkImpl(String name, NimSdkTypeId sdkType, String homePath, String version) {
    this(name, sdkType);
    myHomePath = homePath;
  ...
  public NimSdkTypeId getSdkType() {
    NimSdkTypeId sdkType = mySdkType;
    if (sdkType == null) {
      mySdkType = sdkType = NimProjectSdkTable.getInstance().getDefaultSdkType();
    }
    return sdkType;
  }
  ...
  public void readExternal(@NotNull Element element, @Nullable NimProjectSdkTable projectJdkTable) throws InvalidDataException {
    ...
    if (sdkTypeName != null) {
      if (projectJdkTable == null) {
        projectJdkTable = NimProjectSdkTable.getInstance();
      }
  ...
  @Override
  @NotNull
  public NimProjectSdkImpl clone() {
    NimProjectSdkImpl newJdk = new NimProjectSdkImpl("", mySdkType);
    copyTo(newJdk);
    return newJdk;
  }
  ...
  public void copyTo(@NotNull NimProjectSdkImpl dest) {
