...
public abstract class NimSdkProjectRootManager extends SimpleModificationTracker {
  /**
   ...
   * @return the instance.
   */
  public static NimSdkProjectRootManager getInstance(@NotNull Project project) {
    return project.getComponent(NimSdkProjectRootManager.class);
  }
   ...
   */
  @Nullable
  public abstract NimSdk getProjectSdk();
   ...
   */
  public abstract void setProjectSdk(@Nullable NimSdk sdk);
