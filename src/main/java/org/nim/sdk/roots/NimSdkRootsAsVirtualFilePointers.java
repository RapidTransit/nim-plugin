 ...
 * @author mike
 */
public class NimSdkRootsAsVirtualFilePointers implements RootProvider {
  ...
  public NimSdkRootsAsVirtualFilePointers(boolean noCopyJars, VirtualFilePointerListener listener, @NotNull Disposable parent) {
  ...
  public void copyRootsFrom(@NotNull RootProvider rootContainer) {
    removeAllRoots();
