...
import org.nim.sdk.NimProjectSdkTable;
import org.nim.sdk.NimSdk;

import java.util.*;

@State(name = "NimProjectRootManager")
public class NimProjectRootManagerImpl extends NimProjectRootManagerEx implements PersistentStateComponent<Element> {
  private static final Logger LOG = Logger.getInstance("#com.intellij.openapi.projectRoots.impl.ProjectRootManagerImpl");

  private static final String PROJECT_JDK_NAME_ATTR = "project-sdk-name";
  private static final String PROJECT_JDK_TYPE_ATTR = "project-sdk-type";
  private static final String ATTRIBUTE_VERSION = "version";

  protected final Project myProject;

  private final EventDispatcher<ProjectNimSdkListener> myProjectJdkEventDispatcher = EventDispatcher.create(ProjectNimSdkListener.class);

  private String myProjectSdkName;
  private String myProjectSdkType;

  private final NimOrderRootsCache myRootsCache;
  ...
  public static NimProjectRootManagerImpl getInstanceImpl(Project project) {
    return (NimProjectRootManagerImpl)getInstance(project);
  }

  public NimProjectRootManagerImpl(@NotNull Project project) {
    myProject = project;
    myRootsCache = new NimOrderRootsCache(project);
  ...
  public OrderEnumerator orderEntries() {
    return new NimProjectOrderEnumerator(myProject, myRootsCache);
  }
  ...
  public NimSdk getProjectSdk() {
    ...
    NimProjectSdkTable projectJdkTable = NimProjectSdkTable.getInstance();
  ...
  @Override
  public void setProjectSdk(NimSdk sdk) {
  ...
  @Override
  public void addProjectJdkListener(@NotNull ProjectNimSdkListener listener) {
    myProjectJdkEventDispatcher.addListener(listener);
  }

  @Override
  public void removeProjectJdkListener(@NotNull ProjectNimSdkListener listener) {
