 ...
 * @author nik
 */
public class NimProjectOrderEnumerator extends NimOrderEnumeratorBase {
  private final Project myProject;

  public NimProjectOrderEnumerator(@NotNull Project project, @Nullable NimOrderRootsCache rootsCache) {
    super(rootsCache);
    myProject = project;
  }
